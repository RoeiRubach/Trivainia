...
namespace Trivainia
{
    ...
    {
        [Title("Clockwise Input Images (Starting from Bottom)"), PreviewField(70), LabelText("Bottom"), PropertySpace(SpaceBefore = 5, SpaceAfter = 5)]
        public Sprite SkillBottom;

        [PreviewField(70), LabelText("Left"), PropertySpace(SpaceBefore = 5, SpaceAfter = 5)]
        public Sprite SkillLeft;

        [PreviewField(70), LabelText("Up"), PropertySpace(SpaceBefore = 5, SpaceAfter = 5)]
        public Sprite SkillUp;

        [PreviewField(70), LabelText("Right"), PropertySpace(SpaceBefore = 5, SpaceAfter = 10)]
